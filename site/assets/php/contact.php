...
$sendToEmail = 'wayne@wcrstudios.com'; // Email address that will receive the message with the output of the form
$sendToName = 'Wayne'; // Name that will receive the message with the output of the form

// Subject
$subject = 'Message from WCR Studios contact form';
...
$smtpHost = 'mail.wcrstudios.com'; // Enter SMTP host ie. smtp.gmail.com
$smtpUsername = 'wayne@wcrstudios.com'; // SMTP username ie. gmail address
$smtpPassword = 'LAUK-scus2jooh'; // SMTP password ie gmail password
...
$recaptchaSecret = '6LcZQYwgAAAAALbo0pXC49p5pNXnpHdkufnNIevm'; // enter your secret key from https://www.google.com/recaptcha/admin
...
try {
  ...
  $fromEmail = $_POST['form_email'];
  $fromName = $_POST['form_name'];
  $emailTextHtml .= "</table>";
  $mail = new PHPMailer;
