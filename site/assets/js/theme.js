  ...
  */
  stickyHeader: () => {
    ...
    var options = {
      ...
      onStick: function() {
        var logo = this.clonedElem.querySelector('.navbar-brand img');
        logo.setAttribute('src', './assets/img/wcr_studios_logo_colors.svg');
      ...
      onUnstick: function() {
        var logo = this.clonedElem.querySelector('.navbar-brand img');
        logo.setAttribute('src', './assets/img/wcr_studios_logo_dark.svg');       
      }
